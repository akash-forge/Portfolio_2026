...
const Hobbies = () => {
  return (
    <section id="hobbies" className="py-24 relative overflow-hidden golden-section">
      <div className="container mx-auto px-6 max-w-5xl text-center">
        <h2 className="text-3xl md:text-5xl font-bold mb-4 text-white">Beyond the Code</h2>
        <div className="w-24 h-1 bg-gradient-to-r from-primary to-secondary mx-auto rounded-full mb-16"></div>
        
        <div className="grid md:grid-cols-2 gap-8">
          {/* Hobby Card */}
          <div className="glass-panel overflow-hidden group hover:-translate-y-2 transition-transform duration-300 flex flex-col text-left">
          ...
          <div className="glass-panel overflow-hidden group hover:-translate-y-2 transition-transform duration-300 flex flex-col text-left">
            ...
            <div className="p-8">
              <h3 className="text-2xl font-bold text-white mb-4">Fitness & Strength</h3>
              <p className="text-gray-300 text-lg leading-relaxed">
